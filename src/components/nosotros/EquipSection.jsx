                        ...
                        <Card key={i} className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105 border-0">
                            <CardHeader className="text-center ">
                                ...
                                group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                                    <equipo.icono className='h-12 w-12 text-white'/>
                                </div>
                                <CardTitle className="text-xl font-bold text-gray-800">{equipo.titulo}</CardTitle>
                            ...
                            <CardContent className="text-center space-y-4 pb-4">
                                ...
                                <CardDescription className="text-gray-600 leading-relaxed">{equipo.descripcion}</CardDescription>
                            </CardContent>
                        </Card>
                    ))}
                </div>
