        ...
        <section className='py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-800 via-gray-800 to-slate-900 text-white' >
            ...
            <div className='container mx-auto px-4 md:px-6'>
                ...
                <div className='flex flex-col items-center justify-center space-y-6 text-center mb-16'>
                    ...
                    <p className='text-gray-300 text-xl leading-relaxed' data-aos="fade-up" data-aos-delay="150">Estos valores siempre nos guiaran a quienes somos y que ofrecemos.</p>
                </div>
                ...
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    {values.map((value, i) => (
                        <Card key={i} className='bg-white/5  border-white/10 text-white hover:bg-white/10 transition-transform duration-300 group hover:scale-105' data-aos="zoom-in" data-aos-delay={i * 150}> 
