        ...
        <section className="relative min-h-screen overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                ...
                <div className="bg-sky-500 flex flex-col items-center justify-center p-8 text-center md:text-left md:items-start md:order-first">
                    ...
                    <p className="text-white/90 text-lg md:text-xl mb-8 max-w-md">Nuestro servicio te ofrece los mejores autolavados para que su vehiculo quede reluciente por dentro y por fuera.</p>
                    <Link>
